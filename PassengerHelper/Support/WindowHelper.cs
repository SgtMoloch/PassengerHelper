...
namespace PassengerHelper
{
    internal class WindowHelper
    {
        ...
        public static void CreateWindow<TWindow>(string identifier, int width, int height, Window.Position position, Window.Sizing sizing = default(Window.Sizing), Action<TWindow> configure = null) where TWindow : Component, IBuilderWindow
        {
